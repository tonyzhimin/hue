    ...
    <%actionbar:render>
      ...
      <%def name="creation()">
        <form class="form-inline">
            ...
            <a href="javascript:void(0)" onclick="window.location.href = window.HUE_BASE_URL + '/desktop/download_logs'" class="btn"><i class="fa fa-download"></i> ${_('Download entire log as zip')}</a>
        </form>
      </%def>
    </%actionbar:render>
